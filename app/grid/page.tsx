...
export const metadata: Metadata = {
  title: "Grid",
  description:
    "How late Indian inter-state transmission actually runs, from the Ministry of Power's own tabling, applied to announced data centre capacity.",
};
  ...
  return (
    <div className="mx-auto w-full min-w-0 max-w-5xl px-5">
      <section className="py-14">
        <p className="sc text-accent">The physical register</p>
        <h1 className="mt-3 max-w-3xl font-serif text-4xl leading-[1.1] tracking-tight">
          The grid decides how much of the buildout lands
        </h1>
        <p className="mt-5 max-w-2xl leading-relaxed text-muted">
          Announcements are measured in gigawatts and delivery in megawatts.
          Rather than argue about company intent, this measures the
          infrastructure: how late Indian inter-state transmission actually runs,
          according to the Ministry of Power&apos;s own record.
        </p>
      </section>
